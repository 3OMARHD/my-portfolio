...
const Footer: React.FC<FooterProps> = ({ id }) => {
  ...
  {/* Footer Content */}
  <footer id={id} className="bg-gray-900 dark:bg-black border-t border-gray-800">
        <div className="max-w-screen-xl mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="lg:col-span-2">
              <h3 className="text-2xl font-bold text-white mb-4">Omar Hossam Ahmed</h3>
              <p className="text-gray-400 mb-6 max-w-md">
                Cybersecurity student passionate about the field and striving to become a professional cybersecurity consultant. 
                Building secure solutions for a safer digital world.
              </p>
              <div className="flex space-x-4">
                <a 
                  href="https://github.com/3OMARHD" 
                ...
                <a 
                  href="https://www.linkedin.com/in/omar-securespace" 
                  className="text-gray-400 hover:text-white transition-colors duration-300"
                  aria-label="LinkedIn"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a 
                  href="mailto:omar.hossam.ahmed@example.com" 
                  className="text-gray-400 hover:text-white transition-colors duration-300"
                  aria-label="Email"
                >
                ...
                <a 
                  href="https://tryhackme.com/p/3OMARHD" 
                  className="text-gray-400 hover:text-white transition-colors duration-300"
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="OmarHossamAhmed_CV.pdf" className="text-gray-400 hover:text-white transition-colors duration-300 flex items-center">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-gray-400 text-sm mb-4 md:mb-0">
                © {new Date().getFullYear()} Omar Hossam Ahmed. All rights reserved.
              </div>
